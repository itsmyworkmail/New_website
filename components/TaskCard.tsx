...
export default function TaskCard({ task, onUpdateTask, onDeleteTask }: TaskProps) {
    ...
    return (
        <div className="group bg-card hover:bg-muted/50 border border-border/40 p-3 rounded-lg flex flex-col gap-2 transition-all duration-300 h-full shadow-sm hover:shadow-md hover:border-border/80">
